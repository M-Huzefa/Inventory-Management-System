<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accountant.aspx.cs" Inherits="InventorySystem.Accountant" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row i-row">
                ...
                <div class="col">
                    <asp:LinkButton class="btn btn-success my-2 my-sm-0" runat="server" onclick="Bills">
                        <i class="fa-solid fa-file-invoice-dollar"></i><br />Generate Bills
                    </asp:LinkButton>
                </div>
            </div>

            <div class="row t-row">
                <div class="col">ACCOUNTANT PORTAL</div>
            </div>
